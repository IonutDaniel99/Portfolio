...
import ScreenThree from './Home/Screens/projectsPanels/ScreenThree'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/Projects/porto' element={<ScreenThree />}></Route>
      </Routes>
      <BackToPortfolio />
    </BrowserRouter>
  )
...
const BackToPortfolio = () => {
  ...
  return (
    <NavLink to={'/'} className='absolute top-10 left-10'>
      <p className='flex items-center justify-center w-40 h-12 font-bold text-gray-700 duration-500 ease-in-out bg-white border-2 border-blue-400 hover:text-orange-600 rounded-xl hover:w-56 hover:border-orange-600'>
        Back To Portfolio
      </p>
    </NavLink>
  )
