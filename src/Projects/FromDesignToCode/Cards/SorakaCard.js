          ...
          <div className='px-4 pt-3'>
            ...
            <div className='py-3 '>
              ...
              <p className='text-[10px] font-roboto text-[#1e2328]'>
                An age ago, when time itself was young, the inhabitants of the celestial realm regarded the fledgling races of Runeterra with growing
                concern. These creatures deviated wildly, unpredictably... <span className='underline cursor-pointer text-[#7996E1] '>Read more</span>
              </p>
            </div>
            ...
            <div className='px-4 pt-3'>
              ...
              <div className='py-3 '>
                ...
                <p className='text-[10px] font-roboto'>
                  An age ago, when time itself was young, the inhabitants of the celestial realm regarded the fledgling races of Runeterra with
                  growing concern. These creatures deviated wildly, unpredictably...{' '}
