...
function TristanaCard() {
    return (
        <div className='bg-[#1F1F1F] w-[450px] h-full flex items-center justify-center flex-col relative text-[#F0E6D2]'>
            <card className="bg-gradient-to-br from-black to-[#2d2d2d]  w-80 rounded-xl scale-[.99]">
                <img src='/Images/Cards/leagueoflegends/tristana.jpg' alt='' className='border-b-[1px] rounded-tr-xl rounded-tl-xl' />
            ...
            <a href='https://www.figma.com/file/twErNtJeSSPDBTtgYSwuCW/My-Figma-Projects?node-id=23%3A10&t=u2HWXKgglTw5yEsc-0' target="_blank" rel="noreferrer" className='relative text-gray-300 underline top-6 opacity-60 hover:text-blue-600'>Source</a>
