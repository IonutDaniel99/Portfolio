...
function IndonesiaApp() {
    return (
        <div className='flex justify-center w-screen h-screen text-white'>
            <div className='absolute w-full h-full bg-center bg-cover -z-50 blur-lg brightness-75 backdrop-brightness-0 saturate-50' style={{ backgroundImage: `url("/Images/Indonesia/bg-mountain.jpg")` }} />
            <div className='w-9/12 px-32 py-10'>
                <nav className='flex flex-row items-center w-full h-16'>
                    ...
                    <span className='flex items-center float-right h-20 pr-10 w-fit'>
                        <img src='/Images/Indonesia/search.png' alt="Search Icon" className='w-8 h-6 duration-300 ease-in-out cursor-pointer invert hover:invert-0' />
                    </span>
                </nav>
                <div className='mt-8 mb-8 h-[450px] rounded-2xl relative group duration-300 ease-in-out hover:scale-110'>
                    <div className='absolute w-full h-full bg-center bg-cover -z-40 saturate-150 brightness-75 rounded-2xl ' style={{ backgroundImage: `url("/Images/Indonesia/bg-mountain.jpg")` }}></div>
                    <div className='flex flex-col items-center justify-center w-full h-full'>
                        ...
                        <span className='relative w-2/6 text-lg text-center text-gray-300 top-4'>Indonesia is one of the best country in the world <br /> with a thousand of beautiful islands </span>
                ...
                <div>
                    ...
                    <cards className="flex flex-row justify-between gap-4">
                        <div className='h-56 w-[23rem] bg-cover bg-center rounded-2xl saturate-200 brightness-125 duration-300 ease-in-out hover:scale-105 cursor-pointer' style={{ backgroundImage: `url("/Images/Indonesia/wisnuKenkana.jpg")` }}>
                        ...
                        <div className='h-56 w-[23rem] bg-cover bg-center rounded-2xl duration-300 ease-in-out hover:scale-105 cursor-pointer' style={{ backgroundImage: `url("/Images/Indonesia/penida.jpg")` }}>
                            <div className='flex flex-col items-start justify-end w-full h-full px-8 py-4'>
                                <span className='text-4xl font-AlexBrush'>Nusa</span>
                                <span className='text-4xl font-BebasNeue'>PENID</span>
                            </div>
                        </div>
                        <div className='h-56 w-[23rem] bg-cover bg-center rounded-2xl duration-300 ease-in-out hover:scale-105 cursor-pointer' style={{ backgroundImage: `url("/Images/Indonesia/bajo.jpg")` }}>
                            <div className='flex flex-col items-start justify-end w-full h-full px-8 py-4'>
            ...
            <div className='absolute text-lg bottom-2 right-4 '>
                <p>Design from <a href='https://www.instagram.com/goldwinhalim' target='_blank' alt="instagram goldwinhalim" rel="noreferrer" className='text-blue-300 underline'>@goldwinhalim</a></p>
            </div>
        </div>
    )
}
