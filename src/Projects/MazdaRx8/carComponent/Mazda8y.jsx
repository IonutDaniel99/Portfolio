...
Command: npx gltfjsx@6.1.4 mazda8y.gltf
Author: Serg_Stark... (https://sketchfab.com/Serg_str)
License: CC-BY-NC-SA-4.0 (http://creativecommons.org/licenses/by-nc-sa/4.0/)
Source: https://sketchfab.com/3d-models/mazda-rx-8-a5d28d9c88894d3797f6888d25ac0714
Title: Mazda RX-8
*/
...
function Model({ carWheelSpeed = 2.5 }) {
  ...
  return (
    <group dispose={null} position={[INITIAL_CAR_POSITION, 0, 0]} ref={carMeshRef} receiveShadow castShadow>
      <group rotation={[-Math.PI / 3.2, 1.56, 1.55]} position={[0, 0.50, 0.4]} scale={1.45}>
        ...
        <mesh geometry={nodes.Object_81.geometry} material={materials.material_3} position={[0, 0.59, -0.92]} rotation={[0, 0, -Math.PI / 2]} >
        </mesh>
        <mesh geometry={nodes.Object_83.geometry} material={materials.material_16} position={[0, 0.79, -1.09]} />
