...
function Experience() {
  ...
  return (
    <div
      className='flex flex-col items-center w-screen h-1/2 experience
      mobile:mb-40 mobile:w-full 
      tablet:px-4 tablet:mb-0
     '
    >
      <div
        className='z-10 pt-20 text-white experienceTitle clipFade font-Mitr font-medium border-b-4 text-4xl border-white border-solid pb-2.5
        laptop:text-5xl
      '
      >
        Work Experience
      ...
      >
        <div
          className='text-base text-white title1 clipFade flex flex-col font-Mitr gap-2
