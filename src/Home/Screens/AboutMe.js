            ...
            <div className="relative z-10 flex justify-between w-screen h-screen text-white font-Mitr aboutMe">
                <div className="flex items-center w-full gap-20 ml-20 z-[3]">
                    <div className="flex flex-col gap-16 -mt-24">
                        <p className="font-semibold tracking-wider text-9xl min-w-[1000px] clipFade myName">
                            Hi, I`m DANIEL
                        </p>
                    ...
                    <div className="w-[470px] h-[650px] ml-10 myPhoto relative ">
                        <p className="absolute flex items-center justify-center w-full h-full text-2xl text-center opacity-0 thisIsMe">And this is a photo with me! 😄</p>
                        <img
                            src="https://picsum.photos/470/650"
                            alt=""
                            className="absolute w-[470px] h-[650px] clipFade myPhoto "
                        />
                    </div>
                </div>
            </div>
